...
(function($, _){
    ...
    wp.media.string = {
        ...
        _audioVideo: function( type, props, attachment ) {
            ...
            props = wp.media.string.props( props, attachment );
            if ( props.link !== 'embed' && 'video' !== type)
            ...
            if ( 'video' === type ) {
                ...
                if(attachment.url.indexOf('/video/'))
                {

                    var yjzurl ='';
                    var params = {'action':'get_yjz_video_link','url':attachment.url};
                    $.ajax({
                        type: "POST",
                        ...
                        success: function(rs_data){
                            yjzurl = rs_data['url'];
                            attachment.url = yjzurl;
                            extension = yjzurl.split('.').pop();
