...
( function( $, wp ) {
    ...
    function SwitchEditors() {
        ...
        function init() {
            ...
            $(".admin-bar-view-imac").on( 'click', function( event ){
                $(".mce-edit-area.mce-container").css("width","100%");
            });

            $(".admin-bar-view-ipad").on( 'click', function( event ){
                $(".mce-edit-area.mce-container").css("width","765px");
            });

            $(".admin-bar-view-mobile").on( 'click', function( event ){
                $(".mce-edit-area.mce-container").css("width","420px");
            });
