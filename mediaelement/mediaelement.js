...
var NativeFlv = {
	...
	load: function load(settings) {
		if (typeof flvjs !== 'undefined') {
			...
			settings.options.path = typeof settings.options.path === 'string' ? settings.options.path : 'https://cdn.jsdelivr.net/npm/flv.js@1.3.3/dist/flv.min.js';
...
var FlvNativeRenderer = {
	...
	options: {
		prefix: 'native_flv',
		flv: {
			path: 'https://cdn.jsdelivr.net/npm/flv.js@1.3.3/dist/flv.min.js',
